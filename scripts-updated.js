...
window.loadAppointments = loadAppointments;// scripts-updated.js - Frontend JavaScript for LineUp Two-Sided Platform
...
function displayResults(data) {
  ...
  // Modern Recommendations - NO IMAGES
